...
def captureTerraformObjects(path):
    ...
    def captureCurlyBraces(file, line):
        '''
        Get everything between to curly braces. Used to handle Terraform
        syntax.
        '''
        ...
        while(True):
            ...
            # End if all braces are closed and Terraform object has been
            # captured.
            if braces == 0:
                break
    ...
    def createVariable(tfObject):
        ...
        try:
            tfDescription = findall(
                'description\\s+\\=\\s+\"(.+)\"', tfObject)[0]
    ...
    def createVersion(tfObject):
        ...
        try:
            ...
            # Since Terraform version statement is optional we can pass
            # IndexErrors
            pass
        ...
        try:
            ...
            # Since Terraform source statement is optional we can pass
            # IndexErrors
            pass
        ...
        try:
            ...
            for i in range(0, len(tfProviderVersion)):
                verObject['Modules'][i].update(
                    {'version': tfProviderVersion[i]})
        except BaseException:
            # Since Terraform version statement is optional we can pass
            # IndexErrors
            pass
